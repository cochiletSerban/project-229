...
function getModeHeaderVals() {
  switch (roomState.modeName) {
    case "maxLight":
      let brightness229 =
        (roomState.state229.state2.brightness +
          roomState.state229.state22.brightness +
          roomState.state229.state229.brightness) /
        3;
      let stateBrightness =
        (roomState.whiteStrip + brightness229 + roomState.roof.brightness) / 3;
...
function initModes() {
  switch (roomState.modeName) {
    ...
    case "club":
      // header
      uiElements.headers.club229Header.css(
        "background-color",
        getCssVars("myOrange")
      );
    ...
    case "maxLight":
      // header
      uiElements.headers.maxLightHeader.css(
        "background-color",
        getCssVars("myOrange")
      );
      uiElements.headers.maxLightHeader
        .find("div.col.s9.left-align > h5")
        .text("Max light @ " + getModeHeaderVals());
    ...
    case "moodLight":
      ...
      uiElements.headers.moodHeader
        .find("div.col.s9.left-align > h5")
        .text("Mood light @ " + headerState.brightness);
    ...
    case "lobby":
      // header
      uiElements.headers.lobbyHeader.css(
        "background-color",
        getCssVars("myOrange")
      );
